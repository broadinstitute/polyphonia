...
The primary output file generated by polyphonia is a table detailing evidence for potential cross-contamination events. This output table has the following columns:
