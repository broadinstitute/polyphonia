...
- Scripts are written in [Perl 5](https://www.perl.org/get.html).
   - Float values are rounded using [Math::Round ≥0.07](https://metacpan.org/pod/Math::Round).
   - Parallelization is performed using [Parallel::ForkManager ≥2.02](https://metacpan.org/pod/Parallel::ForkManager).
- Allele frequencies are calculated by [LoFreq ≥2.1.5](https://csb5.github.io/lofreq/installation/).
- Sequence alignments are generated by [MAFFT ≥7.480](https://mafft.cbrc.jp/alignment/software/).
- Visualizations are done in [R](https://www.r-project.org/) using [tidyverse ≥1.2.1](https://www.tidyverse.org/).
