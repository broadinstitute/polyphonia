...
- `potential_contaminated_sample_unambiguous_bases`
- `potential_contaminated_sample_genome_covered`
- `num_positions_with_heterozygosity`
- `alleles_at_positions_with_heterozygosity`
- `potential_contaminating_sample`: the sample proposed to be the source of this contamination event.
- `potential_contaminating_sample_unambiguous_bases`
- `potential_contaminating_sample_genome_covered`
